...
proustBooks = [
  ...
  {
    id: 2,
    title: "In the shade of young girls in bloom",
    price: 600,
    year: 1919,
    pages: 2100,
  },
  ...
  {
    id: 4,
    title: "Sodom and Gomorrah I and II",
    price: 800,
    year: 1921,
    pages: 2441,
  },
...
for (book of proustBooks) {
  ...
  bookCard.innerHTML = `<h3>Titulo: ${book.title}</h3>
...
hoja.innerHTML =
  "div {border: 2px solid black; background-color: aliceblue; display: inline-table; margin: 20px; height : 100px; padding: 50px;}";
